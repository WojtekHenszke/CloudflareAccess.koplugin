...
describe("config custom headers", function()
    ...
    describe("custom empty-allowlist warning ack", function()
        it("defaults to false", function()
            assert.is_false(config.hasAcknowledgedEmptyAllowlistCustomWarning())
        end)

        it("persists after acknowledge", function()
            config.acknowledgeEmptyAllowlistCustomWarning()
            assert.is_true(config.hasAcknowledgedEmptyAllowlistCustomWarning())
        end)

        it("is independent from the CF Access warning ack", function()
            config.acknowledgeEmptyAllowlistWarning()
            assert.is_true(config.hasAcknowledgedEmptyAllowlistWarning())
            assert.is_false(config.hasAcknowledgedEmptyAllowlistCustomWarning())
